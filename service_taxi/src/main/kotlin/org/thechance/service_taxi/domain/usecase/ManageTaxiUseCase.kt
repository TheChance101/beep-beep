...
interface IManageTaxiUseCase {
    ...
    suspend fun findTaxisByPlateNumberAndDriverIds(plateNumber: String,driverIds : List<String>): List<Taxi>
}
...
class ManageTaxiUseCase(
    ...
    override suspend fun findTaxisByPlateNumberAndDriverIds(plateNumber: String, driverIds: List<String>): List<Taxi> {
        return taxiGateway.findTaxisByPlateNumberAndDriverIds(plateNumber,driverIds)
    }
