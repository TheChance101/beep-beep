...
class IraqiArabicLocalizedMessages() : LocalizedMessages {
    ...
    override val invalidUserId: String = "رقم تعريفى ليس موجود"
    override val userAlreadyDeleted: String = "ممسوح من قبل لا تتناصح علينا"
    // endregion
    ...
    override val cuisineNameAlreadyExisted: String = "مو ضيفت هاي المطبخ من قبل!"
    //endregion
}
